...
const log = new Logger("mkdocs-css");

/**
 * The CSS code generator.
 * @category Generators
 */
export class MKDOCSCSSGenerator {
    ...
    private readonly varGroups: {[key:string]: MKDOCSCSSVarGroup} = {};
    private readonly cssColors: {[name: string]: CSSColor} = {};
    private defaultTheme?: MKDOCSCSSTheme;
    ...
    private setAtomVars() {
        ...
        const vk = new MKDOCSCSSVariableKind("atoms","",[], this);
    ...
    private generateTypographyVars(typography: TypographyStyling, prefix: string) {
        ...
        const vk = new MKDOCSCSSVariableKind("molecules.topograpy","",[], this);
    ...
    private setMoleculeVars() {
        ...
        let vk = new MKDOCSCSSVariableKind("molecules","",[], this);
        // dropdowns
        const dd = ms.dropdowns;
        vk = new MKDOCSCSSVariableKind("dropdowns","",[dd.menuElevation], this);
        ...
        vk = new MKDOCSCSSVariableKind("stb","",[stb.buttonText], this);
        ...
        vk = new MKDOCSCSSVariableKind("smb","",[smb.visibleHeight], this);
        ...
        // chip
        const chip = ms.chips;
        vk = new MKDOCSCSSVariableKind("chip","",[chip.minWidth], this);
        ...
        this.addPropVar("chip-text", "", chip.text, function(vk: MKDOCSCSSVariableKind) {
        ...
        vk = new MKDOCSCSSVariableKind("card","",[card.padding], this);
        ...
        vk = new MKDOCSCSSVariableKind("modal","",[modal.borderRadius], this);
        ...
        vk = new MKDOCSCSSVariableKind("tooltip","",[], this);
        vk.setVars({
        ...
        vk = new MKDOCSCSSVariableKind("toast","",[toast.handleBorderRadius], this);
        ...
        vk = new MKDOCSCSSVariableKind("images","",[image.imageElevation], this);
        ...
        vk = new MKDOCSCSSVariableKind("avatar","",[avatar.mediumBorder], this);
        ...
        vk = new MKDOCSCSSVariableKind("slider","",[slider.visibleHeight], this);
        ...
        vk = new MKDOCSCSSVariableKind("popover","",[popover.borderRadius], this);
        ...
        vk = new MKDOCSCSSVariableKind("spacing","",[spacing.sectionPadding], this);
    ...
    private setOrganismVars() {
        ...
        let vk = new MKDOCSCSSVariableKind("organism","",[], this);
        const fc = org.footerAndCopyright;
        vk = new MKDOCSCSSVariableKind("fc","",[fc.footerVerticalPadding], this);
        ...
        vk = new MKDOCSCSSVariableKind("pnav","",[pnav.verticalPadding], this);
        this.addPropVar("navbarPrimary-padding", "", pnav.verticalPadding);
        this.addPropVar("navbarPrimary-position", "", pnav.fixed, function(vk: MKDOCSCSSVariableKind) {
            vk.setVar(vk.name, pnav.fixed.getValue() ? "fixed" : "relative");
        });
        // navbar secondary /
        const snav = org.secondaryNav;
        vk = new MKDOCSCSSVariableKind("snav","",[snav.verticalPadding], this);
        this.addPropVar("navbarSecondary-padding", "", snav.verticalPadding);
        this.addPropVar("navbarSecondary-position", "", snav.sticky, function(vk: MKDOCSCSSVariableKind) {
        ...
        // hero
        const hero = org.hero;
        vk = new MKDOCSCSSVariableKind("hero","",[hero.verticalGap], this);
        ...
        // tables
        vk = new MKDOCSCSSVariableKind("tables","",[], this);
        vk.setVars({
    ...
    private coreSystemSettings() {
        const atoms = this.atoms;
        let vk = new MKDOCSCSSVariableKind("", "", [], this);
        // targets
        ...
        // radius
        vk = new MKDOCSCSSVariableKind("", "", [atoms.borderSettings.baseBorderRadius], this);
        ...
        // spacing
        vk = new MKDOCSCSSVariableKind("", "", [atoms.gridSettings.grid], this);
        ...
        // borders
        vk = new MKDOCSCSSVariableKind("", "", [atoms.borderSettings.baseBorderWidth], this);
        ...
        // elevation settings
        vk = new MKDOCSCSSVariableKind("", "", [atoms.elevationSettings.percentageChange], this);
    ...
    private addBevelProps(props: BevelSettingsProps) {
        ...
        // bevels
        const vk = new MKDOCSCSSVariableKind(p, "", [props.blurRadius], this);
        if (props.standard) {
    ...
    public getVarGroup(name: string): MKDOCSCSSVarGroup {
        let vg = this.varGroups[name];
        if (!vg) {
            vg = new MKDOCSCSSVarGroup(name);
    ...
    private shadowColorListener(vk: MKDOCSCSSVariableKind) {
    ...
    private percentToDecimalListener(varName: string, vk: MKDOCSCSSVariableKind) {
    ...
    private generateFocusBlurVariable(vk: MKDOCSCSSVariableKind) {
    ...
    private generateInputBackgroundVariables(vk: MKDOCSCSSVariableKind) {
    ...
    private setStateSettingsVars(vk: MKDOCSCSSVariableKind) {
        log.debug(`Begin setting state settings variables`);
        if (this.atoms.stateSettings.ready) {
            this.atoms.stateSettings.all.forEach(ss => {
                const gen = this;
                this.addPropVar("ss"+ss.name, "", ss.prop, function(vk1: MKDOCSCSSVariableKind) {
    ...
    public generateHotlinkVariables(vk: MKDOCSCSSVariableKind) {
    ...
    private generateHotlinkModeVariables(vars: HotlinkModeVariables, prefix: string, vk: MKDOCSCSSVariableKind) {
    ...
    private generateOnHotlinkWithDecorationVariables(color: string, vk: MKDOCSCSSVariableKind, vars: OnHotlinkWithDecoration) {
    ...
    private generateOnHotlinkVariables(color: string, vk: MKDOCSCSSVariableKind, vars: OnHotlink) {
    ...
    private shadeListener(args: ShadeListenerArgs, vc: EventValueChange<Shade>) {
        ...
        if (shade) {
            ...
            const pcs = args.pcs;
            const vk = new MKDOCSCSSVariableKind(name,"", [pcs], this);
    ...
    private setShadeVars(name: string, lm: boolean, prefix: string, args: ShadeListenerArgs, shade: Shade, vk: MKDOCSCSSVariableKind) {
    ...
    private setPaletteVars(name: string, lm: boolean, prefix: string, args: ShadeListenerArgs, shades: Shade[], vk: MKDOCSCSSVariableKind) {
        shades.forEach(shade => {
            vk.setShadeVar(`${prefix}${name}-${shade.id}`, shade);
            if (args.on) vk.setShadeVar(`${prefix}on-${name}-${shade.id}`, shade.getOnShade2(lm));
        });
    }
    public setShadeVar(name: string, kind: MKDOCSCSSVariableKind, shade?: Shade) {
        if (shade) {
    ...
    private defaultThemeListener(vc: EventValueChange<string>) {
        ...
        if (name !== undefined) {
            ...
            this.defaultTheme = new MKDOCSCSSTheme(this.atoms.colorThemes.getTheme(name), this);
        }
    ...
    public setVar(name: string, unit: string, kind: MKDOCSCSSVariableKind, value?: any) {
     ...
     */
    public addPropVar(name: string, unit: string, prop: Property<any>, cb?: (propVar: MKDOCSCSSVariableKind) => void) {
        new MKDOCSCSSDynamicVariableKind(name, unit, [prop], this, cb);
    }
     ...
     */
    public addPropsVar(name: string, unit: string, props: Property<any>[], cb: (propVar: MKDOCSCSSVariableKind) => void) {
        new MKDOCSCSSDynamicVariableKind(name, unit, props, this, cb);
    }
...
class CSSColor {
    ...
    private mkdocs_cssGenerator: MKDOCSCSSGenerator;
    private lname: string = '_tb.CssColor';
    private varKind: MKDOCSCSSVariableKind;

    constructor(color: IColor, mkdocs_cssGenerator: MKDOCSCSSGenerator) {
        this.color = color;
        this.mkdocs_cssGenerator = mkdocs_cssGenerator;
        this.varKind = new MKDOCSCSSVariableKind("color", "", [color.hex as Property<string>], mkdocs_cssGenerator);
        this.start();
    }
    ...
    private listener(vc: EventValueChange<string>): void {
        for (const shade of this.color.light.shades) {
            ...
            if (name) {
                this.mkdocs_cssGenerator.setShadeVar(name, this.varKind, shade);
                this.mkdocs_cssGenerator.setShadeVar(`on-${name}`, this.varKind, shade.getOnShade2(true));
            } else {
        ...
        for (const shade of this.color.dark.shades) {
            ...
            if (name) {
                this.mkdocs_cssGenerator.setShadeVar(`dm-${name}`, this.varKind, shade);
                this.mkdocs_cssGenerator.setShadeVar(`dm-on-${name}`, this.varKind, shade.getOnShade2(false));
            } else {
                log.warn(`Unable to set CSS variable for shade ${shade.toString()} because no variable name can be determined`);
            }
        }
...
class MKDOCSCSSTheme {

    public readonly theme: ColorTheme;
    public readonly mkdocs_cssGenerator: MKDOCSCSSGenerator;
    private readonly listenerSubscriptions: ListenerSubscription[] = [];

    constructor(theme: ColorTheme, mkdocs_cssGenerator: MKDOCSCSSGenerator) {
        this.theme = theme;
        this.mkdocs_cssGenerator = mkdocs_cssGenerator;
        this.start();
    }
    ...
    public start() {
        ...
        const molecules = this.mkdocs_cssGenerator.molecules;
        const props = [molecules.dropdowns.menuFocusState, this.theme.button];
        this.mkdocs_cssGenerator.addPropsVar("lm-dropdowns", "", [...props, this.theme.lightModeBackground], this.generateDropDownVars.bind(this, true));
        this.mkdocs_cssGenerator.addPropsVar("dm-dropdowns", "", [...props, this.theme.darkModeBackground], this.generateDropDownVars.bind(this, false));
        ...
        this.theme.addTheme.setListener("hotlinks", function(event) {
            if (event.type === EventType.NodeEnabled) {
                const vk = new MKDOCSCSSVariableKind("hotlinks","",[], self.mkdocs_cssGenerator);
                self.mkdocs_cssGenerator.generateHotlinkVariables(vk);
            }
        });
    ...
    private setShadeListener(args: ShadeListenerArgs) {
        const ls = this.mkdocs_cssGenerator.setShadeListener(args);
    ...
    private backgroundListener(name: string, lm: boolean, pcp: PropertyColorPair, _: EventValueChange<ColorPair>) {
        ...
        const vk = new MKDOCSCSSVariableKind(name,"", [pcp], this.mkdocs_cssGenerator);
        const prefix = lm ? "" : "dm-";
    ...
    private elevationsListener(lm: boolean, _: EventValueChange<ColorPair>) {
        ...
        const vk = new MKDOCSCSSVariableKind("css.elevations","", [pcp], this.mkdocs_cssGenerator);
        const prefix = lm ? "" : "dm-";
    ...
    private shadeGroupListener(type: string, prop: PropertyColorShade, vc: EventValueChange<Shade>): void {
        ...
        const vk = new MKDOCSCSSVariableKind("button", "", [prop], this.mkdocs_cssGenerator);
    ...
    public setShadeVar(name: string, kind: MKDOCSCSSVariableKind, shade: Shade) {
        this.mkdocs_cssGenerator.setShadeVar(name, kind, shade);
    }

    private generateDropDownVars(lm: boolean, vk: MKDOCSCSSVariableKind) {
        log.debug(`generateDropDownVars enter - lm=${lm}`);
        const mfs = this.mkdocs_cssGenerator.molecules.dropdowns.menuFocusState;
    ...
    private lkey(name: string): string {
        return this.mkdocs_cssGenerator.lkey(`CSSTheme.${name}`);
    }

}

export class MKDOCSCSSVariableKind {
    ...
    constructor(name: string, unit: string, props: Property<any>[], mkdocs_cssGenerator: MKDOCSCSSGenerator) {
        this.name = name;
        this.unit = unit;
    ...
    public setVar(name: string, value?: any) {
        this.mkdocs_cssGenerator.setVar(name, this.unit, this, value);
    }
    ...
    private setGroupVars(name: string, type: string, lm: boolean, sg: ShadeGroup) {
        ...
        // Shade isn't correct, so hardcode for now
            ...
            const vars = this.mkdocs_cssGenerator.getVars();

            if (lm) {
                const onPrimary = vars["--on-primary"];
                this.mkdocs_cssGenerator.setVar(`${type}OnTertiary`, "", this, onPrimary);
                const color = (onPrimary == "#121212") ? "#FFFFFF" : "#121212" ;
                this.mkdocs_cssGenerator.setVar(`on${type}OnTertiary`, "", this, color);
                const hColor = (onPrimary == "#121212") ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)";
                this.mkdocs_cssGenerator.setVar(`on${type}HalfOnTertiary`, "", this, hColor);
            }
            else {
                this.mkdocs_cssGenerator.setVar(`dm${type}OnTertiary`, "", this, "rgba(255,255,255,0.6)");
                this.mkdocs_cssGenerator.setVar(`dmon${type}OnTertiary`, "", this, "#121212");
                this.mkdocs_cssGenerator.setVar(`dmHalf${type}HalfOnTertiary`, "", this, "rgba(255,255,255,0.3)");
            }
        }
        // Shade isn't correct, so hardcode for now
            ...
            if (lm) {
                this.mkdocs_cssGenerator.setVar(`${type}OnGradient3`, "", this, "#121212");
                this.mkdocs_cssGenerator.setVar(`on${type}OnGradient3`, "", this, "#FFFFFF");
                this.mkdocs_cssGenerator.setVar(`on${type}HalfOnGradient3`, "", this, "rgba(0,0,0,0.5)");
            }
            else {
                this.mkdocs_cssGenerator.setVar(`dm${type}OnGradient3`, "", this, "rgba(255,255,255,0.6)");
                this.mkdocs_cssGenerator.setVar(`dmon${type}OnGradient3`, "", this, "#121212");
                this.mkdocs_cssGenerator.setVar(`dmHalf${type}HalfOnGradient3`, "", this, "rgba(255,255,255,0.3)");
            }
        }
        else {
            const prefix = lm ? "" : "dm";
    ...
    public setShadeVarRef(name: string, shade: Shade, core?: boolean) {
        ...
        if (varName) {
            this.mkdocs_cssGenerator.setVar(name, "", this, `var(--${varName})`);
        } else {
...
export class MKDOCSCSSDynamicVariableKind extends MKDOCSCSSVariableKind {

    private cb?: (propVar: MKDOCSCSSVariableKind) => void;

    constructor(name: string, unit: string, props: Property<any>[], mkdocs_cssGenerator: MKDOCSCSSGenerator, cb?: (propVar: MKDOCSCSSVariableKind) => void) {
        super(name, unit, props, mkdocs_cssGenerator);
        this.cb = cb;
        const listenerKey = mkdocs_cssGenerator.lkey(name);
        switch (props.length) {
            case 0:
    ...
    private setValue(name: string, unit: string, value: any) {
        this.mkdocs_cssGenerator.setVar(name, unit, this, value);
    }
...
export class MKDOCSCSSVariable {

    public name: string;
    public unit: string;
    public value?: any;
    public kind: MKDOCSCSSVariableKind;

    constructor(name: string, unit: string, kind: MKDOCSCSSVariableKind, value?: any) {
        this.name = name;
        this.unit = unit;
        this.value = value;
        this.kind = kind;
...
export type MKDOCSCSSVarGroupListener = (vg: MKDOCSCSSVarGroup) => void;

export class MKDOCSCSSVarGroup implements IVarGroup {

    public readonly name: string;
    public readonly vars: {[name: string]: string} = {};
    private listeners: {[key: string]: MKDOCSCSSVarGroupListener} = {};

    constructor(name: string) {
        this.name = name;
    }

    public setListener(key: string, listener?: MKDOCSCSSVarGroupListener) {
        if (listener) {
...
function elevationToCSS(vk: MKDOCSCSSVariableKind) {
    const val = vk.props[0].getValue();
    if (val === "No Elevation") {
...
function bevelToCSS(vk: MKDOCSCSSVariableKind) {
    const val = vk.props[0].getValue();
    if (val === "No Bevel") {
...
function colorToCSS(vk: MKDOCSCSSVariableKind) {
    const val = vk.props[0].getValue();
